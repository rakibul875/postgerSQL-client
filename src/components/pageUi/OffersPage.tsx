  ...
  const offers: Offer[] = [
    {
      ...
      description:
        "Welcome to RestaurantHub! Get half off on your very first meal purchase.",
      code: "WELCOME50",
    ...
    },
    {
      ...
      description:
        "Hungry? Order your favorite food and enjoy zero delivery charges.",
      code: "FREESHIP",
    ...
    },
    {
      ...
      description:
        "Order any large pizza or burger combo this weekend and get another absolutely free!",
      code: "BOGOFEAST",
    ...
    },
    {
      ...
      description:
        "Craving authentic items? Get instant discount on all platters.",
      code: "PLATTER10",
